...
public class Product implements Serializable {
	...
	@NotNull(message="Please provide original price")
	@Min(value = 200, message = "Minimum value should be greater than 200")
	...
	public Product(int productId, String productCategory, String productDescription, String productManufacturer,
			String productName,double originalPrice, double productPrice, String unitStock,String productOffer) {
		super();
		this.productId = productId;
		this.productCategory = productCategory;
		this.productDescription = productDescription;
