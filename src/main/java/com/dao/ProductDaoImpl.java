...
public class ProductDaoImpl implements ProductDao {
	...
	public List<Product> getAllProductsForMen() {
		...
		Session session = sessionFactory.openSession();
		// List<Product> products = session.createQuery("from Product").list();
		List<Product> products = session.createQuery("from Product as p where p.productCategory='Men'").list();
		System.out.println("----- List of Products-----");
		System.out.println(products);
		// session.flush is used for clear cache in the session
		session.flush();
	...
	public List<Product> getAllProductsForWomen() {
		...
		Session session = sessionFactory.openSession();
		// List<Product> products = session.createQuery("from Product").list();
		List<Product> products = session.createQuery("from Product as p where p.productCategory='Women'").list();
		System.out.println("----- List of Products-----");
		System.out.println(products);
		// session.flush is used for clear cache in the session
		session.flush();
	...
	public List<Product> getAllProductsForKids() {
		...
		Session session = sessionFactory.openSession();
		// List<Product> products = session.createQuery("from Product").list();
		List<Product> products = session.createQuery("from Product as p where p.productCategory='Kids'").list();
		System.out.println("----- List of Products-----");
		System.out.println(products);
		// session.flush is used for clear cache in the session
		session.flush();
	...
	public List<Product> getAllProductsOfOffer() {
		...
		Session session = sessionFactory.openSession();
		// List<Product> products = session.createQuery("from Product").list();
		List<Product> products = session.createQuery("from Product as p where p.productOffer='yes'").list();
		System.out.println("----- List of Products-----");
		System.out.println(products);
		// session.flush is used for clear cache in the session
		session.flush();
	...
	public List<Product> getSearchItems(String text) {
		Session session = sessionFactory.openSession();
		// List<Product> products = session.createQuery("from Product").list();
		List<Product> products = session.createQuery("from Product as p where p.productName like '%"+text+"%' or p.productDescription like '%"+text+"%'").list();
		System.out.println("----- List of Products-----");
		System.out.println(products);
		// session.flush is used for clear cache in the session
		session.flush();
