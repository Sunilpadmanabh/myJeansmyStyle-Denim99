				...
				<form:form method="post" action="${url}" commandName="productFormObj" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
								 <form:radiobutton path="productCategory" value="Women"/>Women
								 <form:radiobutton path="productCategory" value="Men"/>Men
								 <form:radiobutton path="productCategory" value="Kids"/>Kids
<%-- 								 <form:radiobutton path="productCategory" value="Mac"/>Mac --%>
							...
							<div class="col-sm-4 form-group">
								<form:label path="originalPrice">Original Price</form:label>
								 <form:input type="text"
									...
									path="originalPrice"></form:input>
								 <form:errors path="originalPrice"></form:errors>
							</div>
						...
						<div class="form-group">
						<%-- <form:label path="productCategory">&nbsp;&nbsp;&nbsp;&nbsp;Product Offer</form:label>
							<br>	 --%><div>  &nbsp;&nbsp;&nbsp;
								 <form:checkbox path="ProductOffer" value="yes"/>Product Offer
<%-- 								 <form:checkbox path="productOffer" value="No"/>No --%>
