...
<div class="col-sm-9 col-md-9 col-lg-10 content equal-height">
	<div class="content-area-right">
		<div class="content-crumb-div">
			<a href="">Home</a> / <a href="">Your Account</a> / Reset Password
		</div>
		<div class="row">
			<div class="col-md-5 forgot-form">
				<p>Please enter your email address below and we will send you
					...
					<label class="label-default" for="un">Email</label> <input
				name="email" class="form-control" type="text"><br>
				<label class="label-default" for="un">Password</label> <input
				name="password" class="form-control" type="password"><br>
				<label class="label-default" for="un">Confirm Password</label> <input
				name="confirmPassword" class="form-control" type="password"><br>
			...
			<div class="col-md-5 forgot-return" style="display: none;">
				...
				<p>An email has been sent to your address with a reset password
					you can use to access your account.</p>
			</div>
		</div>
	</div>
</div>
