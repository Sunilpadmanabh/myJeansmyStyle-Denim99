...
<div class="col-sm-9 col-md-9 col-lg-10 content equal-height">
	<div class="content-area-right">
		<div class="content-crumb-div">
			<a href="index1">Home</a> / <a href="">Your Account</a> / Forgot Password
		</div>
		<div class="row">
			<div class="col-md-5 forgot-form">
				...
				<label class="label-default" for="un">Email Address</label> <input
				name="email" class="form-control" type="text"><br>
				<!-- <a href="sendresettoken" id="mybad" class="btn btn-primary" role="button">RESET</a> -->
