		...
		<!-- <div ng-app="myapp" ng-controller="myController"
			...
			<div>
				...
				<div>
					...
					<a href="removeAllItemsWithoutLogin/${cartId}" class="btn btn-danger pull-left" 
						style="margin-top: 15px; margin-left: 20px"> <span
						class="glyphicon glyphicon-remove-sign"> </span>Clear Cart
					</a>
				</div>
				<div>
					<c:url value="/orderWithoutLogin/${cartId}" var="url1"></c:url>
				...
				<table class="table table-hover" id="productList">
					...
					<c:forEach items="${carts}" var="cart">
						...
						<td style="width: 171px">
							...
							<td>${cart.price}<td>
							<td><a href="removeCartItemWithoutLogin/${cart.cartItemId}" class="btn btn-danger"
